...
$ActivityId=$_GET['id'];
$Blogs = $mysqli->query("SELECT * FROM project WHERE proid=$ActivityId");
$SiProjects=$Blogs->fetch_array();
$Title=$SiProjects['title'];
$Description=$SiProjects['description'];
$donors=$SiProjects['donor'];
$areas=$SiProjects['area'];
$durations=$SiProjects['duration'];
$contexts=$SiProjects['context'];
$themess=$SiProjects['themes'];
$objectives=$SiProjects['objective'];
$approachs=$SiProjects['approach'];
$majors=$SiProjects['major'];
...
$add_sql = $mysqli->query("UPDATE project SET title = '$DataTitle', description = '$DataDescription', donor = '$donation',area = '$area',duration = '$duration',context = '$context',themes = '$themes',objective = '$objective',approach = '$approach',major = '$major',image = '$filename16' WHERE proid=$ActivityId");
if($add_sql = TRUE){
              ...
              <div class="box-body">
                <form action="" method="post" enctype="multipart/form-data">
                  ...
                  <LABEL>DONATION</LABEL>
                   <div>
                  <textarea name="donor" class="textarea" placeholder="<?=$donors?>"
                  style="width: 100%; height: 125px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                </div>
                <LABEL>AREA</LABEL>
                <div>
                  <textarea name="area" class="textarea" placeholder="<?=$areas?>"
                  style="width: 100%; height: 125px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                </div>
                <LABEL>DURATION</LABEL>
                <div>
                  <textarea name="duration" class="textarea" placeholder="<?=$durations?>"
                  style="width: 100%; height: 125px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                </div>
                <LABEL>CONTEXT</LABEL>
                <div>
                ...
                <LABEL>THEMES</LABEL>
                <div>
                  <textarea name="themes" class="textarea" placeholder="<?=$themess?>"
                  style="width: 100%; height: 125px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                </div>
                <LABEL>OBJECTIVE</LABEL>
                <div>
                  <textarea name="objectives" class="textarea" placeholder="<?=$objectives?>"
                  style="width: 100%; height: 125px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                </div>
                <LABEL>APPROACH</LABEL>
                <div>
                  <textarea name="approach" class="textarea" placeholder="<?=$approachs?>"
                  style="width: 100%; height: 125px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                </div>
                  <LABEL>MAJOR ACTIVITIES</LABEL>
                <div>
                  <textarea name="major" class="textarea" placeholder="<?=$majors?>"
                  style="width: 100%; height: 125px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                </div>
